...
mod tests {
    ...
    // Prefix notation (pre-order traversal of the syntax tree) of lambda calculus terms; unambiguous; therefore no parenthesis are needed.
    // Like binary lambda calculus, but with the following symbols instead of bit-sequences:
    // - Variables: De-Bruijn indices as 0-based base-10 integers,
    // - Abstractions/Lambda: `\`
    // - Applications: `@`
    ...
    // Computes the n-th factorial (Scott-encoded numeral).
    // https://esolangs.org/wiki/Scott_numeral
    ...
    fn test_eval_factorial() {
        ...
        let blc = factorial(n);
        println!(
            "Term for computing {n}-th factorial (scott-encoded): {:?}",
            blc
        );
        // 

        let ast = debruijn::decode_blc(&blc).unwrap();
        let res = eval((&ast).into());
        let blcres = debruijn::encode_blc(&((&res.reduced_term).into()));
        println!("reduced in {} steps to {}", res.steps, blcres);
        // 

        let facn = convert_prefix_notation(&scott(facn)).unwrap();
        assert!(facn == blcres);
    ...
    fn test_eval_hardcoded() {
        let cases = [
            ...
            EvalTestCase {
                ...
                reduced: "(λ_0. ((_0 (λ_1. (λ_2. _2))) (λ_3. ((_3 (λ_4. (λ_5. _5))) (λ_6. ((_6 (λ_7. (λ_8. _7))) (λ_9. ((_9 (λ_10. (λ_11. _11))) (λ_12. (λ_13. _13))))))))))",
            },
            EvalTestCase {
            ...
            EvalTestCase {
                ...
                reduced: "(λ_0. ((_0 (λ_1. (λ_2. _2))) (λ_3. ((_3 (λ_4. (λ_5. _4))) (λ_6. ((_6 (λ_7. (λ_8. _8))) (λ_9. (λ_10. _10))))))))", // [101]
            },
            EvalTestCase {
            ...
            EvalTestCase {
                ...
                reduced: "(λ_0. ((_0 (λ_1. (λ_2. _2))) (λ_3. (λ_4. _4))))", // [1]
            },
            EvalTestCase {
            ...
            EvalTestCase {
                ...
                reduced: "(λ_0. (λ_1. (_0 (_0 (_0 (_0 (_0 (_0 _1))))))))", // 6
            },
            EvalTestCase {
                ...
                reduced: "(λ_0. (λ_1. (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 _1))))))))))))", // 10
            },
            EvalTestCase {
            ...
            EvalTestCase {
                ...
                reduced: "(λ_0. (λ_1. (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 (_0 _1))))))))))))))", // 12
            },
            EvalTestCase {
